weapon:SetMesh("rv", "grenade_02/rv1_lod0.mesh", 0)
...
weapon.icon = texture("/ui/skinF/lobby/grenade_02.tga")
weapon.kill_icon = texture("/ui/weapon/grenade_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/grenade_02.tga")
