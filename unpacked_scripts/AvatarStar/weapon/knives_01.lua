weapon:SetMesh("rv", "knives_01/rv1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/knives_01.tga")
weapon.kill_icon = texture("/ui/weapon/knives_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/knives_01.tga")
...
weapon.pause_time1 = 0.13
weapon.pause_time2 = 0.13
