weapon:SetMesh("rv", "machinegun_07/rv1_lod0.mesh")
weapon.skeleton = "/skeleton/machinegun_01.skel"
weapon.animation_set = "machinegun_01"
weapon.icon = texture("/ui/skinF/lobby/machinegun_07.tga")
