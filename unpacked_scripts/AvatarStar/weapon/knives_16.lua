weapon:SetMesh("rv", "knives_16/rv1_lod0.mesh")
weapon.ik_enable = false
weapon.hand_bind_type = "kHandNone"
weapon.skeleton = "/skeleton/knives_08.skel"
weapon.animation_set = "knives_08"
weapon.icon = texture("/ui/skinF/lobby/knives_16.tga")
weapon.kill_icon = texture("/ui/weapon/knives_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/knives_16.tga")
weapon.cross_hair_icon = texture("/ui/weapon/knives.dds")
weapon.name = "knives_16"
weapon.trail_particle = "knives_08_smoke"
weapon.is_saw = true
