weapon:SetMesh("rv", "knives_07/rv1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/knives_07.tga")
weapon.kill_icon = texture("/ui/weapon/knives_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/knives_07.tga")
