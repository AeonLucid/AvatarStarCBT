weapon:SetMesh("rv", "knives_02/rv1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/knives_02.tga")
weapon.kill_icon = texture("/ui/weapon/knives_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/knives_02.tga")
weapon.cross_hair_icon = texture("/ui/weapon/knives.dds")
weapon.name = "knives_02"
